		...
		"AtVenue": {
			...
			args: args{
				store: &MockStore{
					...
					MockGetSinglePlayerMachineStats: func(_ context.Context, _, venueKey string) ([]db.PlayerMachineStats, error) {
						if venueKey != "" {
							return []db.PlayerMachineStats{
								{MachineKey: "TAF", Games: 3, P50Score: 45_000_000},
							}, nil
						}
						return []db.PlayerMachineStats{
			...
			want: want{
				result: &Result{
					...
					VenueStats: []MachineStats{
						{MachineKey: "TAF", MachineName: "The Addams Family", Games: 3, P50Score: 45_000_000, LeagueP50: 30_000_000},
					},
					GlobalStats: []MachineStats{
						{MachineKey: "TAF", MachineName: "The Addams Family", Games: 10, P50Score: 50_000_000, LeagueP50: 30_000_000},
						{MachineKey: "MM", MachineName: "Medieval Madness", Games: 8, P50Score: 20_000_000, LeagueP50: 15_000_000, NoVenueData: true},
					},
					Analysis: Analysis{
